...
* Notes
** Python
In a pythons virtual enviroment install "debugpy" to work with dapmod
...
#+RESULTS:
| org-ref-org-menu | org-tempo-setup | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-fold-show-all append local] 5] | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-babel-show-result-all append local] 5] | org-babel-result-hide-spec | org-babel-hide-all-hashes | (closure (t) nil (add-hook 'after-save-hook #'efs/org-babel-tangle-config)) | efs/org-mode-visual-fill | org-bullets-mode | efs/org-mode-setup | (closure (t) nil (display-line-numbers-mode 0)) |
...
#+RESULTS:
: tempo-template-python-plot-block-with-latex
...
* Org-Fragtog
Automatically toggle latex fragements previews when the cursor enters themm
